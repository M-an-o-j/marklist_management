...
def signinService(db, teacher, db_teacher):
        ...
        access_token = create_access_token(data={"sub": str(db_teacher.teacher_id)}, expires_delta=expiry_del)
...
def updateTeacherService(db,teacher_id,teacher):
    try:
